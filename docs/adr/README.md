...
| [0023](./0023-the-authority-console-is-an-aggregating-trusted-surface.md) | The authority console is an aggregating trusted surface, not a new authority | accepted | add-authority-console (M8) |
| [0024](./0024-the-kill-switch-instant-revocation-via-deny-list-and-keycloak.md) | The kill switch — instant revocation via a deny-list, an agent-wide Keycloak kill, and an honest residual | accepted | add-instant-revocation (M9) |
...
| Locked: authority console as aggregating surface (M8) | ADR-0023 |
| Locked: the kill switch — deny-list + agent-wide Keycloak kill (M9) | ADR-0024 |
