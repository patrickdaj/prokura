# authority-console — new capability (add-authority-console / M8)
...
event as revocation from the consent surface, and the console SHALL state
honestly that effect occurs on the next broker hand-out (instant propagation is
