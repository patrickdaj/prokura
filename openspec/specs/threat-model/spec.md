...
The required contents and rigor of the Prokura threat model — assets, actors/attacker model, trust boundaries, STRIDE-per-flow coverage, attack trees for high-value targets, threat→mitigation mapping, a residual-risk register, and a reader-facing findings narrative. Acceptance criteria are stated so completeness is checkable, not subjective. Realized in [docs/threat-model.md](../../../docs/threat-model.md) and [docs/blog/m6-threat-model.html](../../../docs/blog/m6-threat-model.html).
